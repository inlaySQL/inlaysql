...
`free_list_reuse_dst` went from **187 s for both its sweeps to 1,902 s** —
10.2× — essentially all of it in the heavy-churn one, which alone is 1,465 s
against the raw-scan one's 78 s.
