...
fn delta(a: CommitStats, b: CommitStats) -> CommitStats {
    CommitStats {
        ...
        gate_read_ns: a.gate_read_ns - b.gate_read_ns,
        gate_reads: a.gate_reads - b.gate_reads,
        gate_state_ns: a.gate_state_ns - b.gate_state_ns,
        gate_state_writes: a.gate_state_writes - b.gate_state_writes,
        gate_wal_ns: a.gate_wal_ns - b.gate_wal_ns,
        gate_wal_writes: a.gate_wal_writes - b.gate_wal_writes,
        gate_wal_bytes: a.gate_wal_bytes - b.gate_wal_bytes,
        gate_data_ns: a.gate_data_ns - b.gate_data_ns,
        gate_data_writes: a.gate_data_writes - b.gate_data_writes,
        gate_data_bytes: a.gate_data_bytes - b.gate_data_bytes,
        gate_extend_ns: a.gate_extend_ns - b.gate_extend_ns,
        gate_extends: a.gate_extends - b.gate_extends,
        gate_phase_ns: core::array::from_fn(|i| a.gate_phase_ns[i] - b.gate_phase_ns[i]),
        gate_point_misses: a.gate_point_misses - b.gate_point_misses,
